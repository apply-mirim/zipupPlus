        ...
        <div className="mt-4 flex flex-col gap-5 lg:mt-6">
          <Section title="1. 수집하는 개인정보 항목">
            <ul className="flex flex-col gap-1">
              ...
              <li>· 관심 지역 등 회원가입 시 선택적으로 입력한 정보</li>
            </ul>
          </Section>

          <Section title="2. 개인정보 수집 및 이용 목적">
            <p>
              <BrokenText text="수집한 정보는 지역별 전세사기 위험도 정보를 제공하기 위한 목적으로만 사용됩니다. 구체적으로는 회원 식별 및 로그인 유지, 관심 지역 기반 위험 정보 제공, 서비스 품질 개선을 위한 통계 분석에 활용됩니다." />
            </p>
          </Section>

          <Section title="3. 개인정보의 제3자 제공">
            <p className="mb-1.5">
              <BrokenText text="회사는 원칙적으로 이용자의 개인정보를 외부에 제공하지 않으나, 아래의 경우 서비스 제공을 위해 필요한 최소한의 정보를 제3자에게 전달합니다." />
            </p>
            <ul className="flex flex-col gap-1">
              <li>
          ...
          <Section title="4. 개인정보의 보관 및 삭제">
            <p>
              <BrokenText text="이용자의 개인정보는 회원 탈퇴 시 지체 없이 파기됩니다. 관련 데이터는 회원 탈퇴와 함께 삭제되며, 별도로 다운로드하거나 백업해두지 않은 데이터는 복구할 수 없습니다. 관계 법령에 따라 일정 기간 보관이 필요한 정보가 있는 경우 해당 법령에서 정한 기간 동안 별도 보관 후 파기합니다." />
            </p>
          </Section>

          <Section title="5. 이용자의 권리">
            <p>
              <BrokenText text="이용자는 회원탈퇴를 통해 본인의 개인정보 및 관련 데이터 삭제를 요청할 수 있습니다. 그 밖의 문의사항은 고객센터를 통해 접수해주세요." />
            </p>
          </Section>

          <Section title="6. 서비스 이용에 따른 법적 책임">
            <p>
              <BrokenText text="안심 시그널 맵의 지역 위험도 정보는 참고 자료이며, 법률 자문이나 전문가의 진단을 대체하지 않습니다. 산정에는 오류나 누락이 있을 수 있으므로, 이용자는 계약 체결이나 실제 상황 판단 전 반드시 등기부등본 등 원본 서류를 직접 확인하고 필요시 공인중개사·변호사 등 전문가와 상담해야 합니다. 정보를 참고해 이용자가 내린 계약·법적 판단 및 그로 인한 결과에 대한 책임은 이용자 본인에게 있으며, 회사는 정보의 정확성을 보증하지 않습니다." />
            </p>
          </Section>
        </div>
      </div>
